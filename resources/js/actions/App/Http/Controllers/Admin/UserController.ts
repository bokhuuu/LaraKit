...
* @see app/Http/Controllers/Admin/UserController.php:98
...
* @see app/Http/Controllers/Admin/UserController.php:113
* @route '/admin/users/{user}'
*/
...
* @see app/Http/Controllers/Admin/UserController.php:127

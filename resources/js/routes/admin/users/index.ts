...
* @see app/Http/Controllers/Admin/UserController.php:46
* @route '/admin/users'
*/
...
* @see app/Http/Controllers/Admin/UserController.php:60
...
* @see app/Http/Controllers/Admin/UserController.php:100
* @route '/admin/users/{user}'
*/
